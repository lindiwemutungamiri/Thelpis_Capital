...
$(function () {
	...
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-left' style='margin-right:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-left'>Save Changes</button> "
    },
    {
