						...
						<div class="doc-review review-listing custom-edit-service">
							...
							<div class="card">
								<div class="card-body">
									...
									<form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="addBlog.php">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														...
														<input class="form-control" name="title" type="text" name="service_title" id="service_title" placeholder="Bitcoin - The Future Or The Present" required>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														...
														<textarea id="about" class="form-control service-desc" name="body" required></textarea>
													</div>
												</div>
											</div>
										</div>
										<div class="submit-section">
											<button class="btn btn-primary submit-btn" name="formSubmit" type="submit" name="form_submit" value="submit">Submit</button>
										</div>
									</form>
