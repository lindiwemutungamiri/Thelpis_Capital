...
<body class="theme-warning">
	...
	<header>
		<nav hidden class="nav-white nav-transparent dark-overlay">
			...
			<ul class="menu">
				...
				<li>
					...
					<div id="confirm">
						...
						<button class="yes"><a href="https://paxful.com" class="px-10 pt-15 pb-10" target="_blank">
								<div class="btn btn-primary py-5">Yes, redirect</div>
							</a></button>
						<button class="yes"><a href="index3.html" class="px-10 pt-15 pb-10">
								<div class="btn btn-primary py-5">Stay on Page</div>
							</a></button>
					</div>
				</li>
				<li class="megamenu">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-3">
								<ul class="list-group">
									...
									<li><a href="adminLoginPage.php"><i class="ti-arrow-circle-right me-10"></i>Login Admin</a></li>
									<li><a href="adminRegisterPage.php"><i class="ti-arrow-circle-right me-10"></i>Register Admin</a></li>
			...
			<ul class="attributes">
				<li class="d-md-block d-none"><a href="adminRegisterPage.php" class="px-10 pt-15 pb-10">
				...
				<div class="col-lg-5 col-md-5 col-12">
					<div class="box box-body">
						...
						<div class="p-40">
							...
							<div class="text-center">
								<p class="mt-15 mb-0">Don't have an account? <a href="adminRegisterPage.php" class="text-warning ms-5">Register</a></p>
							</div>
						</div>
					</div>
