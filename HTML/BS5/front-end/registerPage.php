<<<<<<< HEAD:HTML/BS5/front-end/register.html
﻿<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="icon" href="../images/Tee.ico">
...
<body class="theme-warning">
	...
	<header>
		<nav hidden class="nav-white nav-transparent dark-overlay">
						...
						<div class="row">
							<div class="col-lg-3 col-3">
								<ul class="list-group">
									...
									<li><a href="testimonial.html"><i class="ti-arrow-circle-right me-10"></i>Testimonials</a></li>
			...
			<ul class="attributes">
				<li class="d-md-block d-none"><a href="register.html" class="px-10 pt-15 pb-10"><div class="btn btn-primary py-5">Register Now</div></a></li>
...
?>
>>>>>>> 0ef41aa93eb94012831b64b67ebd3aaaebd47239:HTML/BS5/front-end/registerPage.php
